...
correlations <- data.frame(
  ...
  correlation = c(
    cor(wide_data$p_error_pc, wide_data$p_error_phone),
    cor(wide_data$non_p_error_pc, wide_data$non_p_error_phone),
    cor(wide_data$clr_percent_pc, wide_data$clr_percent_phone),
    cor(wide_data$trails_first_category_pc, wide_data$trails_first_category_phone)
  )
)
